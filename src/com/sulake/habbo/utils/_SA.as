package com.sulake.habbo.utils
{
	 ...
	 * @author Richard
	 */
	public class _SA extends EventDispatcherWrapper implements _02o
	{
		protected var _N6:URLRequest;

		public function _SA(param1:LoaderContext = null, param2:Boolean = false, param3:Boolean = false)
		{
			super();
			// if(param1 == null)
			// {
