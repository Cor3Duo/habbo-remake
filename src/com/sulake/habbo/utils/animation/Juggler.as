package com.sulake.habbo.utils.animation
{
  ...
  public class Juggler implements class_65
  {
    ...
    private var var_30:Vector.<class_65>;
    ...
    public function Juggler()
    {
      super();
      mElapsedTime = 0;
      var_30 = new Vector.<class_65>(0);
    }

    public function add(param1:class_65):void
    {
      var _loc2_:EventDispatcher = null;
      if (param1 && var_30.indexOf(param1) == -1)
      {
        var_30[var_30.length] = param1;
    ...
    {
      return var_30.indexOf(param1) != -1;
    }
    ...
    public function remove(param1:class_65):void
    {
      ...
      var _loc2_:int = int(var_30.indexOf(param1));
      if (_loc2_ != -1)
      {
        var_30[_loc2_] = null;
      }
    ...
    public function removeTweens(param1:Object):void
    {
      ...
      _loc3_ = var_30.length - 1;
      while (_loc3_ >= 0)
      {
        _loc2_ = var_30[_loc3_] as Tween;
    ...
    public function purge():void
    {
      var _loc1_:int = 0;
      var _loc2_:EventDispatcher = null;
      _loc1_ = var_30.length - 1;
      while (_loc1_ >= 0)
      {
        _loc2_ = var_30[_loc1_] as EventDispatcher;
        if (_loc2_)
        {
          _loc2_.removeEventListener("REMOVE_FROM_JUGGLER", onRemove);
        }
    ...
    public function advanceTime(param1:Number):void
    {
      ...
      var _loc4_:int = int(var_30.length);
      var _loc3_:int = 0;
      mElapsedTime += param1;
      if (_loc4_ == 0)
      {
      ...
      while (_loc2_ < _loc4_)
      {
        _loc5_ = var_30[_loc2_];
        if (_loc5_)
        {
          if (_loc3_ != _loc2_)
          {
            var_30[_loc3_] = _loc5_;
            var_30[_loc2_] = null;
          }
      ...
      if (_loc3_ != _loc2_)
      {
        _loc4_ = int(var_30.length);
        while (_loc2_ < _loc4_)
        {
          var_30[_loc3_++] = var_30[_loc2_++];
        }
        var_30.length = _loc3_;
      }
    }
