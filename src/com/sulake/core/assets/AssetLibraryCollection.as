package com.sulake.core.assets
{
  ...
  public class AssetLibraryCollection extends EventDispatcherWrapper implements class_21
  {

    protected var var_24:Vector.<class_21>;

    protected var var_120:Array;

    protected var var_247:LoaderContext;

    protected var var_137:AssetLibrary;

    protected var var_68:XML;

    protected var _name:String;

    private var var_1523:uint = 0;
    ...
    public function AssetLibraryCollection(param1:String)
    {
      ...
      _name = param1;
      var_68 = null;
      var_24 = new Vector.<class_21>();
      var_120 = [];
      var_247 = new LoaderContext(false, ApplicationDomain.currentDomain, null);
    }
    ...
    private function get binLibrary():class_21
    {
      if (!var_137)
      {
        var_137 = new AssetLibrary("bin");
        var_24.splice(0, 0, var_137);
      }
      return var_137;
    }
    ...
    public function loadFromFile(param1:class_39, param2:Boolean = false):void
    {
      ...
      {
        loaderContext = var_247;
      }
      var _loc3_:class_21 = new AssetLibrary("lib-" + var_1523++);
      var_120.push(_loc3_);
    ...
    {
      while (var_120.length > 0)
      {
        (var_120.pop() as class_21).dispose();
      }
      while (var_24.length > 0)
      {
        (var_24.pop() as class_21).dispose();
      }
    }
    ...
    private function loadEventHandler(param1:class_43):void
    {
      ...
      if (param1.type == "LIBRARY_LOADER_EVENT_COMPLETE")
      {
        ...
        _loc4_ = 0;
        while (_loc4_ < var_120.length)
        {
          _loc2_ = var_120[_loc4_] as class_21;
          if (_loc2_.url == _loc3_.url)
          {
            var_120.splice(_loc4_, 1);
            break;
          }
          _loc4_++;
        }
    ...
    public function getAssetLibraryByName(param1:String):class_21
    {
      for each (var _loc2_:* in var_24)
      {
        if (_loc2_.name == param1)
    ...
    public function getAssetLibraryByUrl(param1:String):class_21
    {
      for each (var _loc2_:* in var_24)
      {
    ...
    public function getAssetLibraryByPartialUrl(param1:String):class_21
    {
      for each (var _loc2_:* in var_24)
      {
    ...
    public function addAssetLibrary(param1:class_21):void
    {
    ...
    public function removeAssetLibrary(param1:class_21):void
    {
      var _loc2_:int = int(var_24.indexOf(param1));
      if (_loc2_ >= 0)
      {
    ...
    private function buildManifest():XML
    {
      ...
      if (var_137)
      {
        applyManifestNodes(_loc1_, var_137);
      }
      for each (var _loc2_:* in var_24)
      {
    ...
    private function applyManifestNodes(param1:XMLList, param2:class_21):void
    {
      var _loc3_:XML = null;
